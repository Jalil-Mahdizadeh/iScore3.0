...
The broad concept is feasible but is not unprecedented. BANANA, CASTER-DTA, 3DProtDTA, HoloProt, Graph_RG, and PLANET are important prior art. The defensible research opportunity is a strictly ligand-3D-free system that combines multi-scale receptor geometry with gMolAI atom/global features, explicit uncertainty, apo/predicted-structure stress tests, and unusually rigorous leakage controls.
...
- [evidence/publications.tsv](evidence/publications.tsv) — 71 evaluated publications/methods/resources with coordinate-use classification
- [evidence/software.tsv](evidence/software.tsv) — 36 source-code, input-interface, reproducibility, and licence audits
- [evidence/datasets.tsv](evidence/datasets.tsv) — 46 dataset, benchmark, structure, and mapping records with versions, roles, access, and caveats
...
- [references/references.bib](references/references.bib) — 66 core bibliographic records
